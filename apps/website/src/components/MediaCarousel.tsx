            ...
            {slides.length > 0 &&
                slides.map((image, index) => (
                    <button
                        ...
                        className={`flex absolute inset-0 justify-center ${index === currentIndex ? 'scale-100 cursor-default!' : 'scale-90'} ${isResetting ? 'transition-none' : 'transition-all'} duration-500`}
                    >
                        <div
